package frc.robot.hotpath.util;
...
public class HolonomicPathFollowerConfig {
   ...
   *
   * @param translationConstants {@link frc.robot.hotpath.util.PIDConstants} used for creating the
   *     translation PID controllers
   * @param rotationConstants {@link frc.robot.hotpath.util.PIDConstants} used for creating the
